<?php 
	...
	$sqlquery = 'SELECT * FROM image_info WHERE iowner="'.$_SESSION["session_eamil"].'" and istatus="1"';
			...
			<div class="col-md-10">
				...
				<div class="container" style="text-align: center;">
					<div class="pagination">
						<?php
							echo '<a href="privatecollection.php?page=1"><<</a>';
							for ($i=1; $i <= $page_num; $i++) { 
								echo '<a class="'.activate($i).'" href="privatecollection.php?page='.$i.'">'.$i.'</a>';
							}
							echo '<a href="privatecollection.php?page='.$page_num.'">>></a>';
						?>
					</div>
				</div>
				...
				<div style="margin-left: 2%; margin-right: 2%;">
					<div class="row">
						<?php
							$sqlquery = 'SELECT * FROM image_info WHERE iowner="'.$_SESSION["session_eamil"].'" and istatus="1"'.'LIMIT '.$first.','.$per_page;
							$result = mysqli_query($link,$sqlquery) or die(mysqli_error());
